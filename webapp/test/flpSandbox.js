		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#OrderSystemordersystem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"OrderSystemordersystem-display": {
								"semanticObject": "OrderSystemordersystem",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=OrderSystem.ordersystem",
									"url": sap.ui.require.toUrl("OrderSystem/ordersystem")
								}
							}
						}
					}
